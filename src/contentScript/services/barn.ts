...
class Barn {
  ...
  private _blackList = JSON.parse(localStorage.getItem('barnBlackList') ?? '[]');

  private readonly _button;
  private readonly recycler;

  constructor() {
    this.recycler = new RecyclerBase(RecyclerTypes.barn);
